...
function AwardCard({ award, index, onSelect }: {
  ...
  return (
    <motion.button
      ...
      onClick={onSelect}
      className="group relative w-full aspect-[4/3] rounded-2xl overflow-hidden bg-secondary border border-border hover:border-foreground/20 transition-all duration-500 focus:outline-none focus-visible:ring-2 focus-visible:ring-foreground/30 text-left shadow-card"
    >
      <motion.img
        src={media[0].src}
      ...
      <section className="relative min-h-[70vh] flex items-center overflow-hidden bg-background">
        ...
        >
          <motion.div
            ...
            className="max-w-2xl"
          >
            <p className="text-muted-foreground text-sm font-medium tracking-[0.15em] uppercase mb-4 flex items-center gap-2">
            ...
            <h1 className="text-4xl sm:text-5xl lg:text-7xl font-bold tracking-tight leading-[1.05] text-foreground">
              Events &
              <br />
              <span className="text-muted-foreground">honours.</span>
            </h1>
          </motion.div>
        </div>
      </section>
