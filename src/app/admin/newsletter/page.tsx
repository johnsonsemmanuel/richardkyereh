          ...
          <table className="w-full">
            <thead className="bg-secondary">
              <tr>
                ...
                <th className="px-6 py-3 text-left text-xs font-medium text-muted-foreground uppercase tracking-wider">Subscribed</th>
              </tr>
            </thead>
            <tbody className="divide-y divide-input">
              {newsletters.length === 0 ? (
                ...
                newsletters.map((sub: { _id: string; email: string; subscribedAt: string; source?: string }) => (
                  <tr key={sub._id} className="hover:bg-secondary transition-colors">
