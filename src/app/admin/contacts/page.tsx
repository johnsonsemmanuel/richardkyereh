  ...
  return (
    <div className="max-w-7xl mx-auto px-4 sm:px-6 py-6 sm:py-8">
      <div className="mb-6">
        ...
        <p className="text-sm text-muted-foreground">Manage contact form requests</p>
      </div>
              ...
              <table className="w-full">
                <thead className="bg-secondary">
                  <tr>
                    ...
                    <th className="px-6 py-3 text-left text-xs font-medium text-muted-foreground uppercase tracking-wider">Inquiry Type</th>
                ...
                <tbody className="divide-y divide-input">
                  {contacts.map((contact: { _id: string; name: string; subject: string; status: string; email: string; company?: string; inquiryType?: string; createdAt: string }) => (
                    <tr key={contact._id} className="hover:bg-secondary transition-colors">
