                  ...
                  {view === "menu" && (
                    ...
                    >
                      ...
                      <div className="grid gap-2">
                        ...
                        <button onClick={() => { setOpen(false); window.location.href = "/booking?service=meeting"; }} className="flex items-center gap-3 p-3 rounded-xl bg-secondary/50 hover:bg-secondary border border-transparent hover:border-border transition-all group text-left">
