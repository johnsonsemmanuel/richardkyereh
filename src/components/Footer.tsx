  ...
  return (
    <footer className="relative overflow-hidden bg-background border-t border-input mt-20">
      ...
      <div className="relative z-10 max-w-6xl mx-auto px-4 py-16 lg:py-20">
        <div className="relative bg-card rounded-3xl border border-input/40 p-8 md:p-12 shadow-2xl shadow-primary/5">
          <div className="hidden md:block absolute -top-3 -left-3 w-20 h-9 scale-75 text-foreground/20 rotate-[-8deg]">
            {tape}
          </div>
          <div className="hidden md:block absolute -top-3 -right-3 w-20 h-9 scale-75 text-foreground/20 rotate-[98deg]">
            {tape}
          </div>
